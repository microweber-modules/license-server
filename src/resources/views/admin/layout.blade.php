        ...
        <div class="container px-5 mb-2">
            ...
            <div>
                ...
                <nav class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-3 newsletter-navigation">
                    <a class="btn btn-outline-dark justify-content-center gap-2 <?php if(route_is('admin.license-server.index')) : ?>active<?php endif;?>" href="<?php print route('admin.license-server.index'); ?>"><i class="mdi mdi-dashboard mr-1"></i> <?php _e('Dashboard'); ?></a>
